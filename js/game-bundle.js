...
define("scenes/templates/default-scene", ["require", "exports"], function (require, exports) {
    ...
    var DefaultScene = /** @class */ (function (_super) {
         ...
         * isDebugModeOn
         */
        DefaultScene.prototype.isDebugModeOn = function (callback) {
            if (this.dato('debug mode')) {
                callback(this.object('texto.debug'));
            }
        };
        /**
         * preload
...
define("functions/preload-character", ["require", "exports"], function (require, exports) {
    ...
    function preloadCharacter(game) {
        game.load.spritesheet('character.main.idle', 'characters/1-Woodcutter/Woodcutter_idle.png', {
            frameWidth: 27,
            frameHeight: 32,
            margin: 0,
            spacing: 21,
        ...
        game.load.spritesheet('character.main.attack.1', 'characters/1-Woodcutter/Woodcutter_attack1.png', {
            frameWidth: 45,
            frameHeight: 38,
            margin: 0,
            spacing: 3,
    ...
    var StartScene = /** @class */ (function (_super) {
        ...
        function StartScene() {
            ...
            _this.$preload = function () {
                ...
                _this.load.image('bg', 'background/PNG/Cartoon_Forest_BG_01/Cartoon_Forest_BG_01.png');
            };
            _this.$create = function () {
